  ...
  grid = new GrapheneDataGrid({
    ...
    actions: [
      ...
      { name: "edit", max: 1 },
      {
        ...
        max: 1,
        min: 1,
        label: '<i class="fa fa-lock"></i> Admins',
      },
      {
        name: "members",
        max: 1,
      ...
      },
      {
        ...
        max: 1,
        min: 1,
        label: '<i class="fa fa-puzzle-piece"></i> Composites',
      },
      "|",
      { name: "create" },
    ...
    .on("model:admins", e => {
      window.location.href =
        "/admin/groups/" + e.model.attributes.id + "/admins";
    })
    .on("model:members", e => {
      window.location.href =
        "/admin/groups/" + e.model.attributes.id + "/members";
    })
    .on("model:composites", e => {
      window.location.href =
        "/admin/groups/" + e.model.attributes.id + "/composites";
    })
    .on("sort", e => {
