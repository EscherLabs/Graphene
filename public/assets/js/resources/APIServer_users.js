...
$.ajax({
	...
	success: function(data){
		tableConfig.schema = [
			...
			{label: null, name:'ipshelptext', type:'output', format:{value: '<div class="alert alert-info">Use the following fields to limit requests to one or more IP Addresses, or part (substring) of an IP Address. (Leave blank to allow from any IP)</div>', parse:false}},
