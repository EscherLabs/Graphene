...
templates["table_head"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<tr style=\"background:#fff;cursor:pointer\" class=\"noselect\">");t.b("\n" + i);if(t.s(t.d("options.hasActions",c,p,1),c,p,0,88,245,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <th style=\"width: 60px;min-width:60px;padding: 0 0 0 20px;\" class=\"select-column\"><i data-event=\"select_all\" class=\"fa fa-2x fa-square-o\"></i></th>");t.b("\n" + i);});c.pop();}t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,284,504,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,301,487,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <th data-sort=\"");t.b(t.v(t.f("cname",c,p,0)));t.b("\"><h6 style=\"margin: 2px;font-size:13px;white-space: nowrap\">");if(t.s(t.d("options.sort",c,p,1),c,p,0,408,446,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<i class=\"fa fa-sort text-muted\"></i> ");});c.pop();}t.b(t.v(t.f("label",c,p,0)));t.b("</h6></th>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("  </tr>");t.b("\n" + i);if(t.s(t.d("options.filter",c,p,1),c,p,0,544,1070,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("  <tr style=\"background:#fff;\" class=\"filter\">");t.b("\n" + i);t.b("    ");if(t.s(t.d("options.hasActions",c,p,1),c,p,0,619,898,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<td>");t.b("\n" + i);t.b("    <div name=\"reset-search\" style=\"position:relative\" class=\"btn\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Clear Filters\">");t.b("\n" + i);t.b("      <i class=\"fa fa-filter\"></i>");t.b("\n" + i);t.b("      <i class=\"fa fa-times text-danger\" style=\"position: absolute;right: 5px;\"></i>");t.b("\n" + i);t.b("    </div>");t.b("\n" + i);t.b("    </td>");});c.pop();}t.b("\n");t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,937,1049,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,954,1032,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <td data-inline=\"");t.b(t.v(t.f("cname",c,p,0)));t.b("\" style=\"min-width:85px\" id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\"></td>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("  </tr>");t.b("\n" + i);});c.pop();}return t.fl(); },partials: {}, subs: {  }});
