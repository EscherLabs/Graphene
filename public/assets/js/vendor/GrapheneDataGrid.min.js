GrapheneDataGrid = function(options) {
	...
	// 	})
	// }
	options.schema = _.map((options.schema || options.form.fields||[]),function(item){
		return gform.normalizeField.call(this,item)
	}.bind(new gform({options:{default:{type:'text'}}}))) ;
