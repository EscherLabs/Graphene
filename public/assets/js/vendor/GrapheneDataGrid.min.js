GrapheneDataGrid = function (options) {
  ...
  Object.defineProperty(this._query, "data", {
    ...
    set: tokens => {
      ...
      if (this.filer instanceof gform) {
        this.filter.set();
...
{{#options.query.bar}}
<input type="text" autocomplete="off" name="query" class="form-control pull-left" style=" margin-bottom:10px;max-width:{{options.query.width}}%;" placeholder="deleted:false">
{{/options.query.bar}}
</div>
    ...
    mapfunc = search => {
      ...
      switch (search.action) {
        ...
        case "@": //date range
          ...
          return (
            ((isNaN(from) || finding > from) && (isNaN(to) || finding < to)) ||
