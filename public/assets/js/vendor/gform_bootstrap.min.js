        ...
        array: {
            template: (data) => {
              ...
              <div data-id="{{id}}" class="col-xs-12">
                ...
                {{#array}}{{^append.enable}}<button data-ref="{{id}}" class="create btn btn-success gform-append">{{create.label}}{{^create.label}}Click here to create {{label}}{{/create.label}}</button>{{/append.enable}}{{/array}}
                </div>`, data || this)
