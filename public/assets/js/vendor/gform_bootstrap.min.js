var gform = function(optionsIn, el){
    ...
    var create = function(){
        ...
        if(this.options.clear && !(this.options.renderer == 'modal')){
            ...
            _.each(gform.create('<div>'+gform.render(this.options.sections+'_container', this.options)+'</div>').childNodes, (a,b,node)=>{
    ...
    this.destroy = function() {
        ...
        gform.each.call(this,(field)=>{
            ...
            // debugger;
            if('el' in field)field.el.remove();
        })
        _.each(this.items.filter({type:'arrayManager'},10),(field)=>{
            if(typeof gform.types[field.type].destroy == "function")gform.types[field.type].destroy.call(field);
            if('el' in field)field.el.remove();
        })
...
gform.collectionManager = function(refObject){
    ...
    var add = (options, data)=>{
        ...
        if(typeof path == 'string'){
            gform.ajax({path: path, success:data => {
                update(name,data)
            }})
        }
        // else{
...
gform.toJSON = function(name) {
    ...
    if(typeof name == 'boolean' && name) {
        return gform.iterators.reduce.call(this,gform.patch,this.options.data,{parsable:true})

    } 
    if(typeof name == 'object') {
        return gform.iterators.reduce.call(this,gform.patch,name,{parsable:true})
    }

    return gform.iterators.reduce.call(this,gform.patch,{},{parsable:true})
}
        ...
        return (options, field) => {
            ...
            if(typeof field.item.value === 'function' || (typeof field.item.method === 'string' && typeof field.owner.methods[field.item.method] == 'function') ) {
                field.derivedValue = (e) => { 
                    field.set((field.owner.methods[field.item.method] || field.item.value).call(null, {form:field.owner,field:field,initial:field,...e}),false)
