...
gform._lookup = (field, args, _lookup) => {
    ...
    if (typeof args.name == 'undefined' || !args.name) looker = field;
                ...
                gform.ajax({
                    ...
                    path: gform.renderString(this.search, { value: value }), success: function (value, data) {
                        if (data.length > 0) {
                            ...
                            var item = _.find(this.options, { value: value }) || _.find(this.options, { label: value })
                            if (typeof item == 'undefined' && this.options.length == 1) item = this.options[0];
                            ...
                            this.set(this.value, true, 'nosearch')
                            this.parent.trigger(['change'], this, { input: this.value });
                        }
                    }.bind(this, value)
                })
