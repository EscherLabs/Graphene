...
gform.addOptionsConditions = function (optgroup) {
    _.each(optgroup.options, function (item) {
        if (item.type == 'optgroup') {
            gform.addOptionsConditions.call(this, item)
        } else {
...
gform.addConditions = function (field) {
    ...
    if (typeof field.mapOptions !== 'undefined') gform.addOptionsConditions.call(this, field);
    // debugger;
    // gform.processConditions.call(this.owner, item.edit, function (id, result, e) {
    //     // if(typeof e.field.el !== 'undefined'){
    //     //     var op = e.field.el.querySelectorAll('[data-id="'+id+'"]');
