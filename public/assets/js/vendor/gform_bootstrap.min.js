var gform = function (optionsIn, el) {
  ...
  if (typeof this.options.data == "string") {
    if (typeof window.location[this.options.data] !== "undefined") {
      ...
      if (path[0] !== "/") {
        path =
          this.options.data(this.options.rootpath || "") + this.options.data;
      }
      gform.ajax({
        path: path,
  ...
  if (_.isString(this.optgroup.path) && this.optgroup.path) {
    if (
      ...
      if (this.collections.get(this.optgroup.path) !== "waiting") {
        ...
        if (path[0] !== "/") {
          path =
            this.options.data(this.owner.options.rootpath || "") +
            this.options.data;
        }
        gform.ajax({
          path: path,
  ...
  set: function (value, silent, input) {
    ...
    if (typeof item !== "undefined") {
      ...
      if (
        ...
        if (path[0] !== "/") {
          path =
            this.options.data(this.owner.options.rootpath || "") + this.search;
        }
        gform.ajax({
