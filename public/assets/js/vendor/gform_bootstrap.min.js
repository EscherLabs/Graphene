var gform = function (optionsIn, el) {
  ...
  var create = function () {
    ...
    this.container =
      this.el.querySelector("fieldset") ||
      ...
      this.handleClick = e => {
        switch (e.target.dataset.click) {
          case "clear":
            ...
            if (this.editable) {
              this.parent.trigger("click", this, {
                action: e.target.dataset.click,
              });
            }
            break;
          default:
            if (e.target.dataset.click) console.log(e.target.dataset.click);
        }
      };
    ...
    get: function () {
      ...
      if (this.multiple) {
        ...
        return _.transform(
          ...
          function (value, item) {
            const search = _.find(that.list, { i: parseInt(item.value) });
            if (typeof search !== "undefined" && "value" in search) {
...
gform.formName = field => {
  return (
    (field.name ||
      (
        gform.renderString(field.legend || field.label || field.title, field) ||
        ""
      )
        .toLowerCase()
        .split(" ")
...
document.body.appendChild(
  gform.create(
    '<style name="gform_style">' +
      gform.render("_style", {}, "all") +
      "</style>"
  )
);
