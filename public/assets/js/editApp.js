...
function load(app_version) {
  ...
  loaded.code = $.extend(true, {
    scripts: [{ name: 'Main', content: '', disabled: true }], templates: [{ name: 'Main', content: '', disabled: true }],
      ...
      fields: [
        ...
        { type: 'switch', format: { label: "" }, horizontal: true, label: 'Custom Actions', name: 'actions', parse: [{ value: true, type: "matches" }] },
        {
          type: 'fieldset', columns: 12, array: true, label: false, name: "actions", show: [{ name: "actions", value: true, type: "matches" }], fields: [
            ...
            { name: "type", columns: 6, label: "Type", type: "combobox", options: ["cancel", "save", "button"], parse: [{ type: "requires" }] },
            ...
            {
              name: "modifiers", columns: 6, label: "Classes", parse: [{ type: "requires" }], type: "combobox", options: [
