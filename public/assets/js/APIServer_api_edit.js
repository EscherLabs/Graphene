...
function load(app_version) {
  ...
  var options = {
    ...
    schema: [
      ...
      {
        label: 'Path', name: 'path', required: true, validate: [{
          type: 'custom', test: e => {
      ...
      {
        label: 'Function Name', name: 'function_name', required: true, validate: [{
          type: 'custom', test: e => {
      ...
      {
        type: "fieldset", label: "Required", name: "required", show: false, parse: true, showColumn: false, array: { max: 100 }, fields: [
      ...
      {
        type: "fieldset", label: "Optional", name: "optional", show: false, parse: true, showColumn: false, array: { max: 100 }, fields: [
          { 'name': 'name', 'label': 'Name', "inline": true, columns: 6 },
          { 'name': 'example', 'label': 'Example', "inline": true, columns: 6 },
          { 'name': 'description', 'label': 'Description', 'type': 'textarea', "inline": true }
          // {'name':'required','label':'Required?','type':'checkbox',falsestate:0,"inline":true,columns:4},
