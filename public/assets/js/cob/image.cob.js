...
Cobler.types.Image = function (container) {
	...
	var fields = {
		...
		"My Images": {
			legend: "My Images", label: false, name: "images", type: 'fieldset', array: { min: 0, max: 25 }, fields: [
				...
				{
					name: 'image', label: 'Image', required: true, type: 'combobox', options: '/api/groups/' + group_id + '/images', custom: {
						name: "addFile", display: '<div style="padding:10px;color:#084010;border-top:solid 1px #333">Upload New File <span class="pull-right"><i class="fa fa-upload"></i></span></div>', action: function (e) {
