  ...
  [
    {
      ...
      name: "size",
      min: 1,
      parse: [{ type: "requires", name: "size" }],
      show: [
        {
          name: "type",
          value: ["textarea", "select", "radio"],
          type: "matches",
        },
      ],
    },
    {
      ...
      type: "select",
      value: "i",
      parse: [{ type: "not_matches", name: "horizontal", value: "i" }],
      options: [
        { label: "Inherit", value: "i" },
    ...
    },
    {
      type: "switch",
      label:
        'Force New Row {{#value}}- <span class="text-success">Yes</span>{{/value}}',
      name: "forceRow",
      show: [
        { name: "columns", value: [12], type: "not_matches" },
        { name: "columns", type: "requires" },
      ],
      parse: [
        { type: "requires" },
        { name: "columns", value: [12], type: "not_matches" },
...

    {
      ...
      parse: [{ type: "not_matches", name: "columns", value: 12 }],
      value: function (e) {
...

    {
      ...
      parse: [
        { type: "not_matches", name: "columns", value: 12 },
        { type: "not_matches", value: 0 },
      ],
      show: [
        { name: "columns", value: [12], type: "not_matches" },
        { name: "columns", type: "requires" },
...

    {
      ...
      format: { label: "" },
      name: "array",
      parse: [{ type: "not_matches", name: "array", value: false }],
      show: [{ name: "type", value: ["output"], type: "not_matches" }],
    },

    {
      ...
      name: "array",
      show: [
        { name: "array", value: true, type: "matches" },
        { name: "type", value: ["output"], type: "not_matches" },
      ],
      fields: [
...
baseFields = _.map(
  [
    ...
    { type: "text", label: "Name", name: "name" },
    {
      ...
      label: "Placeholder",
      name: "placeholder",
      parse: [{ type: "requires", name: "placeholder" }],
      show: [
        {
          name: "type",
          value: ["radio", "checkbox", "switch"],
          type: "not_matches",
        },
      ],
    },
    {
      ...
      columns: 12,
      parse: [{ type: "requires" }],
      show: [{ name: "type", value: ["checkbox"], type: "matches" }],
    },
    {
      type: "text",
      label: "&nbsp;",
      ...
      name: "post",
      parse: [{ type: "requires" }],
      show: [{ name: "type", value: ["select"], type: "matches" }],
    },
    {
      type: "text",
      label: false,
      ...
      show: [
        {
          name: "type",
          value: ["radio", "checkbox", "switch", "color", "select"],
          type: "not_matches",
        },
      ],
    },
...

    {
      ...
      parse: [
        ...
        {
          name: "type",
          value: ["color", "checkbox", "switch", "textarea"],
          type: "not_matches",
        },
      ],
      show: [
    ...
    },
    {
      ...
      parse: [
        ...
        {
          name: "type",
          value: ["color", "number", "checkbox", "switch", "textarea"],
          type: "not_matches",
        },
      ],
      show: [
    ...
    },
    {
      ...
      parse: [
        { type: "requires" },
        { name: "type", value: "textarea", type: "matches" },
      ],
      show: [{ name: "type", value: "textarea", type: "matches" }],
    },
    {
      type: "color",
      label: "Default value",
      ...
      parse: [
        { type: "requires" },
        { type: "not_matches", name: "value", value: "#000000" },
        { name: "type", value: "color", type: "matches" },
      ],
      show: [{ name: "type", value: "color", type: "matches" }],
    },
    // {type: 'date', label: 'Default value', name: 'value',columns:6,show:[{name:"type",value:'date',type:"matches"}]},
    {
      ...
      parse: [
        { type: "requires" },
        { name: "type", value: "number", type: "matches" },
      ],
      show: [{ name: "type", value: "number", type: "matches" }],
    },
    {
      type: "checkbox",
      label: "Default value",
      name: "value",
      parse: [
        { type: "not_matches", name: "value", value: false },
        { type: "matches", name: "type", value: ["checkbox", "switch"] },
      ],
      show: [{ type: "matches", name: "type", value: ["checkbox", "switch"] }],
    },

    {
      ...
      placeholder: 0,
      columns: 4,
      show: [{ type: "matches", name: "type", value: "number" }],
      parse: [
        { type: "matches", name: "type", value: "number" },
        { type: "requires" },
      ],
    },
    {
...

    {
      ...
      columns: 4,
      show: [
        { type: "matches", name: "type", value: "date" },
        { type: "matches", name: "minMaxType", value: false },
      ],
      parse: [
        { type: "matches", name: "type", value: "date" },
        { type: "matches", name: "minMaxType", value: false },
    ...
    },
    {
      ...
      show: [
        { type: "matches", name: "type", value: "date" },
        { type: "matches", name: "minMaxType", value: true },
      ],
      parse: [
        { type: "matches", name: "type", value: "date" },
        { type: "matches", name: "minMaxType", value: true },
    ...
    },
    {
      ...
      columns: 4,
      name: "minMaxType",
      show: [{ type: "matches", name: "type", value: "date" }],
      parse: false,
      options: [
        { label: "Date", value: false },
        { label: "Field", value: true },
      ],
    },
    ...
    },
    {
      ...
      name: "multiple",
      min: 1,
      show: [{ name: "type", value: ["select", "radio"], type: "matches" }],
    },
    {
      type: "number",
      ...
      min: 1,
      show: [
        { name: "type", value: ["select", "radio"], type: "matches" },
        { name: "multiple", value: true, type: "matches" },
      ],
    },
    {
      type: "number",
      ...
      min: 1,
      parse: [
        { name: "type", value: ["select", "radio"], type: "not_matches" },
        { type: "requires" },
      ],
      show: [{ name: "type", value: ["select", "radio"], type: "not_matches" }],
    },
    {
      type: "checkbox",
      label: "Fillable",
      ...
      value: true,
      name: "fillable",
      parse: [{ type: "not_matches", value: true }],
    },
  ],
  function (item) {
...
minCond = [
  {
    ...
    other: true,
    columns: 12,
    label: 'Show the field <span class="pull-right text-muted">"show"</span>',
    value: true,
    name: "show",
...

  {
    ...
    columns: 12,
    label:
      'Allow the field to be Edited <span class="pull-right text-muted">"edit"</span>',
    value: true,
    name: "edit",
    parse: [{ type: "not_matches", name: "/edit", value: true }],
    options: [
      {
        type: "optgroup",
        options: [
  ...
  },
  {
    ...
    fields: myconditions,
    array: { min: 1, max: 1 },
    show: [{ name: "/edit", value: ["other"], type: "matches" }],
  },
];
baseCond = minCond.concat([
  {
    ...
    columns: 12,
    label:
      'Include value in data <span class="pull-right text-muted">"parse"</span>',
    value: "show",
    name: "parse",
    parse: [
      {
  ...
  },
  {
    ...
    fields: myconditions,
    array: { min: 1, max: 1 },
    show: [{ name: "parse", value: ["other"], type: "matches" }],
  },

  {
    ...
    value: false,
    name: "required",
    parse: [{ type: "not_matches", name: "required", value: false }],
    options: [
      {
        type: "optgroup",
        options: [
  ...
  },
  {
    ...
    fields: myconditions,
    array: { min: 1, max: 1 },
    show: [{ name: "required", value: ["other"], type: "matches" }],
  },
]);
...
if (typeof workflow !== "undefined") {
  baseCond = [
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: "Methods",
          options: "methods",
          format: { value: "method:{{value}}", label: "Method: {{label}}" },
        },
      ],
    },
    {
...

    {
      ...
      value: "show",
      name: "parse",
      parse: [{ type: "not_matches", name: "parse", value: "show" }],
      options: [
        {
          type: "optgroup",
          options: [
  ...
  baseCond.splice(
    ...
    0,
    {
      ...
      columns: 12,
      label:
        'Include value in report <span class="pull-right text-muted">"report"</span>',
      value: "show",
      name: "report",
      parse: [{ type: "not_matches", name: "report", value: "show" }],
      options: [
        {
          type: "optgroup",
          options: [
    ...
    },
    {
      ...
      fields: myconditions,
      array: { min: 1, max: 1 },
      show: [{ name: "report", value: ["other"], type: "matches" }],
    }
  );
}
    ...
    [
      {
        ...
        name: "validate",
        format: { label: "" },
        parse: [{ type: "not_matches", name: "validate", value: false }],
      },

      {
        ...
        fields: [
...

          {
            name: "test",
            label: "Method",
            show: [{ name: "type", value: ["custom"], type: "matches" }],
            type: "combobox",
            options: [
              {
                type: "optgroup",
                label: "Methods",
                options: "methods",
                format: { value: "{{value}}", label: "Method: {{label}}" },
              },
            ],
          },
          {
            ...
            forceRow: true,
            label: "Regex",
            show: [{ name: "type", value: ["pattern"], type: "matches" }],
          },
          {
            name: "flags",
            label: "Flags",
          ...
          },
          {
            name: "name",
            label: "Name",
            show: [{ name: "type", value: ["matches"], type: "matches" }],
          },
          {
            type: "number",
            label: "Minimum",
            ...
            columns: 3,
            show: [
              { name: "type", value: ["numeric", "length"], type: "matches" },
            ],
          },
          {
            type: "number",
          ...
          },
          {
            ...
            label: "Apply",
            name: "conditions",
            show: [{ name: "type", value: ["none"], type: "not_matches" }],
            options: [
              { label: "Always", value: true },
              { label: "Conditionally", value: "other" },
            ],
          },
          {
            ...
            fields: myconditions,
            array: { min: 1, max: 1 },
            show: [{ name: "conditions", value: ["other"], type: "matches" }],
          },
        ],
        array: true,
      },
...
if (typeof workflow == "undefined") {
  baseConditions = baseConditions.concat(
    _.map(
      [
        {
          type: "textarea",
          label: "DataGrid Template",
          name: "template",
          columns: 12,
          parse: [{ type: "requires" }],
        },
        {
          type: "checkbox",
          label: "Hide DataGrid Column by default",
          name: "showColumn",
          value: true,
          columns: 12,
          options: [
...

        {
          ...
          columns: 12,
          parse: [{ type: "requires" }],
          format: { template: "{{value.key}}:{{value.value}}" },
          name: "data",
          fields: [
            {
              label: "Key",
              ...
              parse: [
                { type: "requires" },
                { type: "requires", name: "value" },
              ],
            },
            {
              label: "Value",
              name: "value",
              parse: [{ type: "requires" }, { type: "requires", name: "key" }],
            },
          ],
        },
      ],
...
gformEditor = function (container) {
  return function () {
    ...
    _.each(["show", "edit", "parse", "report", "required"], function (index) {
      if (
        _.isArray(fieldConfig[index]) &&
        typeof fieldConfig[index][0].conditions == "undefined"
      ) {
    ...
    if (_.isArray(fieldConfig.validate)) {
      _.each(fieldConfig.validate, function (item) {
        if (
          _.isArray(item.conditions) &&
          typeof item.conditions[0].conditions == "undefined"
        ) {
      ...
      actions: [
        {
          ...
          target: "#display",
          modifiers: "btn btn-info pull-right visible-lg",
        },
      ],
      clear: false,
      // onSet:function(data){
    ...
    temp.placeholder = (formConfig.data["label"] || "")
      .toLowerCase()
      .split(" ")
      .join("_");

    var mygform = new gform(
      formConfig,
      $(opts.formTarget)[0] || $(container.elementOf(this))[0]
    );
    ...
    mygform.on(
      ...
      function (e) {
        ...
        if (value == "" && typeof e.form.find("label") !== "undefined") {
          targetField.set(
            testForm.filter(placeholder).length == 1
              ? placeholder
              : gform.getUID()
          );
          container.update(e.form.get(), this);
...
Cobler.types.input = function (container) {
  function render() {
    var data = get();
    if (item.type == "output") {
      data.display = gform.renderString(
        (data.format || {}).value || "{{{value}}}",
        data
      );
    }
    return (gform.types[item.type] || gform.types["text"]).render.call(
      _.extend(
        {},
        (gform.types[item.type] || gform.types["text"]).defaults,
        myform.default,
        data
      )
    );
  ...
  var fields = [
    {
      ...
      name: "type",
      value: "text",
      parse: [{ type: "not_matches", name: "type", value: "text" }],
      options: [
    ...
    {
      target: "#collapseDisplay .panel-body",
      type: "fieldset",
      label: false,
      columns: 12,
      name: "format",
      ...
      fields: [
        {
          ...
          format: {
            title:
              'Date Format <span class="pull-right" style="font-weight:normal">{{value}}</span>',
          },
          show: [{ type: "matches", name: "type", value: ["date"] }],
        },
        {
          ...
          columns: 12,
          label: "Display",
          show: [{ type: "matches", value: ["template"], name: "/type" }],
        },
        {
          name: "value",
          type: "textarea",
          columns: 12,
          label: "Display",
          show: [{ type: "matches", value: ["output"], name: "/type" }],
        },
      ],
    },
  ]);
...
Cobler.types.collection = function (container) {
  ...
  function set(newItem) {
    if (["user", "group", "files"].indexOf(newItem.type) == -1) {
      ...
      if (
        typeof newItem.options == "undefined" ||
        _.every(newItem.options, function (e) {
          return typeof e == "object" && e.type !== "optgroup";
        })
      ) {
      ...
      [
        {
          ...
          columns: 12,
          name: "format",
          parse: [{ type: "requires", name: "format" }],
          fields: [
            {
              name: "label",
              label: "Label",
              parse: [{ type: "requires", name: "label" }],
            },
            {
              name: "value",
              label: "Value",
              parse: [{ type: "requires", name: "value" }],
            },
            {
              name: "display",
              label: "Display",
              show: [{ type: "matches", value: "combobox", name: "type" }],
            },
        ...
        },
        {
          ...
          fields: [
            { label: "Section Label (optional)", name: "label" },
            {
              ...
              name: "options_type",
              options: [
                { label: "Resource", value: "string" },
                { label: "Derived", value: "int" },
                { label: "Manual", value: "object" },
              ],
              value: function (e) {
                if (e.event == "initialized") {
                  var result = "object";
                  if (
                    typeof e.initial.parent.initialValue["max"] !==
                      "undefined" &&
                    !isNaN(e.initial.parent.initialValue["max"])
                  ) {
                    result = "int";
                  }
                  if (
                    typeof e.initial.parent.initialValue["path"] !==
                      "undefined" &&
                    e.initial.parent.initialValue["path"].length
                  ) {
                    result = "string";
                  }
                  return result;
            ...
            { name: "type", type: "hidden", value: "optgroup" },
            {
              ...
              parse: [
                { type: "matches", name: "options_type", value: "object" },
              ],
              show: [
                { type: "matches", name: "options_type", value: "object" },
              ],
...

            {
              ...
              name: "path",
              show: [
                { type: "matches", name: "options_type", value: "string" },
              ],
            },
            {
              type: "number",
              ...
              name: "min",
              placeholder: "0",
              show: [{ type: "matches", name: "options_type", value: "int" }],
            },
            {
              type: "number",
              label: "Max",
            ...
            },
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  label: "Display",
                  show: [
                    { type: "matches", value: ["combobox"], name: "/type" },
                  ],
                },
                // {name:"Title",label:"title"}
              ],
            },
            {
              ...
              columns: 12,
              label:
                'Show the Options <span class="pull-right text-muted">"show"</span>',
              value: true,
              name: "show",
              parse: [{ type: "not_matches", name: "show", value: true }],
              options: [
...

            {
              ...
              columns: 12,
              label:
                'Allow the options to be Chosen <span class="pull-right text-muted">"edit"</span>',
              value: true,
              name: "edit",
              parse: [{ type: "not_matches", name: "edit", value: true }],
              options: [
...
Cobler.types.bool = function (container) {
  function render() {
    ...
    _.defaults(options.options, [{ value: false }, { value: true }])[
      options.value ? 1 : 0
    ].selected = true;
    return gform.render(item.type, _.extend({}, myform.default, options));
  }
  ...
  function toJSON() {
    ...
    temp.options = _.map(temp.options, function (i) {
      ...
      [
        {
          ...
          fields: [
            {
              title:
                "{{#parent.index}}True{{/parent.index}}{{^parent.index}}False{{/parent.index}} Label",
              name: "label",
              parse: [{ type: "requires" }],
            },
            {
              title:
                "{{#parent.index}}True{{/parent.index}}{{^parent.index}}False{{/parent.index}} Value",
              name: "value",
              parse: [{ type: "requires" }],
              value: function (e) {
                return typeof e.initial.value !== "string"
                  ? ""
                  : e.initial.value;
              },
            },
...
Cobler.types.section = function (container) {
  ...
  var fields = [
    ...
    },
    {
      ...
      columns: 12,
      name: "format",
      show: [{ type: "matches", name: "/type", value: "template" }],
      parse: [{ type: "requires" }],
      fields: [
        {
          name: "display",
...

    {
      ...
      columns: 9,
      type: "button",
      modifiers: "btn btn-default pull-left margin-bottom",
