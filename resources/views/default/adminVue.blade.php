        ...
        <div class="flex justify-between h-full">
          <div class="flex">
            <div class="shrink-0 flex items-center">
              <a href="/admin"><img style="height:25px" src="/assets/img/graphene_white.png"></a>
            </div>

            <div class="hidden space-x-2 items-center sm:flex">
              <span class="ml-4 text-gray-500">/</span>
              <a class="mx-2 text-gray-100 hover:text-brand-300" target="" href="/admin/projects/{{ $project['id'] }}">{{ $project['name'] }}</a><svg xmlns="http://www.w3.org/500/svg" version="1.1" viewBox="0 0 24 26" fill="none" class="h-6 w-auto text-gray-500 hidden md:inline"><circle class="stroke-current stroke-2" transform="" cx="12" cy="12" r="4"></circle></svg>
              <a class="mx-2 text-gray-100 hover:text-brand-300 capitalize" target="" href="/admin/{{ $resource }}s">{{ $resource }}</a>
