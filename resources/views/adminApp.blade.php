...
<div class="btn-group pull-right">
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane tests" id="tests">
      <div class="row">
        <div class="col-sm-9 styles"><div id="mocha"></div></div>
        <div class="col-sm-3"></div>
      </div>
    </div>
  </div>
...
@section('end_body_scripts_bottom')
  ...
  <!-- <script type='text/javascript' src='/assets/js/vendor/chai.js?cb={{ config("app.cache_bust_id") }}'></script>
  <script type='text/javascript' src='/assets/js/vendor/mocha.js?cb={{ config("app.cache_bust_id") }}'></script> -->
  ...
  <script class="mocha-init">
      ...
      describe('another my test suite', function () {
        it('should have run my global setup', function () {
          // make assertion
            assert.equal([1, 2, 3].indexOf(4), -1);
        });
