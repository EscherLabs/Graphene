...
<dt>Original Submission</dt> <dd>{{^opened_at}}{{original.updated_at.date}} @ {{original.updated_at.time}}{{/opened_at}}{{#opened_at}}{{opened_at.date}} @ {{opened_at.time}}{{/opened_at}}</dd>
